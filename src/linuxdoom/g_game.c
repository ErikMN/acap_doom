...
int dclicktime;
unsigned int dclickstate;
int dclicks;
int dclicktime2;
unsigned int dclickstate2;
int dclicks2;
...
G_DoLoadLevel(void)
{
  ...
  if ((gamemode == commercial) || (gamemode == (GameMode_t)pack_tnt) || (gamemode == (GameMode_t)pack_plut)) {
